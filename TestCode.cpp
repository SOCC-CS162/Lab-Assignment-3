...
void TestCode::testBishops() 
{
  // Create a chessboard
  Chess::createBoard();
  deleteDefaultPieces();

  // Test creating Bishops
  std::cout << "Testing creating bishops (bishops should appear at a1, h1, a8, and h8)" << std::endl;
  Bishop B1('B', 'c', 1);
  Bishop B2('B', 'f', 1);
  Bishop b1('b', 'c', 8);
  Bishop b2('b', 'f', 8);
  ...
  // Test moving bishops in 4 directions
  std::cout << "Testing moving bishops in all 4 possible directions (c1 should move to a3, c8 should move to a6, f1 should move to h3 and f8 should move to h6)" << std::endl;
  B1.move('a', 3);
  b1.move('a', 6);
  B2.move('h', 3);
  b2.move('h', 6);
  ...
  // Test running over obstacles
  std::cout << "Testing running over obstacles (should see no change except for pawn obstacles appearing at b2 and g7)" << std::endl;
  ...
  // Test capturing opposite colored pawns
  std::cout << "Testing capturing opposite colored pawns (should see a3 capture g7, by making 2 moves)  and h6 capture b2 by making two moves)" << std::endl;
  B1.move('f',8);
  B1.move('g', 7);
  b2.move('c',1);
  b2.move('b',2);
  ...
  // Test capturing same colored pawns
  std::cout << "Testing capturing same colored pawns (should see no change except for new pawns appearing at g2 and a3)" << std::endl;
  WhitePawn P2('g',2);
  BlackPawn p2('a', 3);
  B2.move('g',2);
  b2.move('a',3);
  ...
  // Test moving bishops vertically and horizontally
  std::cout << "Testing moving bishops vertically and horizontally (should see no change)" << std::endl;
  B1.move('g', 8);
  B1.move('g', 6);
  b2.move('a', 2);
  b2.move('c', 2);
